...
printf("This is thread for %d iterations. Its identifier is %lu\n", p->count, (unsigned long) pthread_self());
...
printf("This ismain. Its PID is %d\n",(int) getpid());

/* Створення нового потоку, що відображує 30000 символів 'a'. */
  thread1_args.character = 'a';
  thread1_args.count = 30000;
  pthread_create (&thread1_id, NULL, &char_print, &thread1_args);

/* Створення нового потоку, що відображує 20000 символів 'b'. */
